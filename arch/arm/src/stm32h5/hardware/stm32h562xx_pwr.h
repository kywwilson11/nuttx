...
#define STM32H5_PWR_CR1_OFFSET      0x0000  /* Power control register 1 */
#define STM32H5_PWR_CR2_OFFSET      0x0004  /* Power control register 2 */
#define STM32H5_PWR_CR3_OFFSET      0x0008  /* Power control register 3 */
#define STM32H5_PWR_CR4_OFFSET      0x000C  /* Power control register 4 */
#define STM32H5_PWR_SR1_OFFSET      0x0010  /* Power status register 1 */
#define STM32H5_PWR_SR2_OFFSET      0x0014  /* Power status register 2 */
#define STM32H5_PWR_SCR_OFFSET      0x0018  /* Power status clear register */
#define STM32H5_PWR_PUCRA_OFFSET    0x0020  /* Power Port A pull-up control register */
#define STM32H5_PWR_PDCRA_OFFSET    0x0024  /* Power Port A pull-down control register */
#define STM32H5_PWR_PUCRB_OFFSET    0x0028  /* Power Port B pull-up control register */
#define STM32H5_PWR_PDCRB_OFFSET    0x002C  /* Power Port B pull-down control register */
#define STM32H5_PWR_PUCRC_OFFSET    0x0030  /* Power Port C pull-up control register */
#define STM32H5_PWR_PDCRC_OFFSET    0x0034  /* Power Port C pull-down control register */
#define STM32H5_PWR_PUCRD_OFFSET    0x0038  /* Power Port D pull-up control register */
#define STM32H5_PWR_PDCRD_OFFSET    0x003C  /* Power Port D pull-down control register */
#define STM32H5_PWR_PUCRE_OFFSET    0x0040  /* Power Port E pull-up control register */
#define STM32H5_PWR_PDCRE_OFFSET    0x0044  /* Power Port E pull-down control register */
#define STM32H5_PWR_PUCRF_OFFSET    0x0048  /* Power Port F pull-up control register */
#define STM32H5_PWR_PDCRF_OFFSET    0x004C  /* Power Port F pull-down control register */
#define STM32H5_PWR_PUCRG_OFFSET    0x0050  /* Power Port G pull-up control register */
#define STM32H5_PWR_PDCRG_OFFSET    0x0054  /* Power Port G pull-down control register */
#define STM32H5_PWR_PUCRH_OFFSET    0x0058  /* Power Port H pull-up control register */
#define STM32H5_PWR_PDCRH_OFFSET    0x005C  /* Power Port H pull-down control register */
#define STM32H5_PWR_SECCFGR_OFFSET  0x0078  /* Power secure configuration register */
#define STM32H5_PWR_PRIVCFGR_OFFSET 0x0078  /* Power privilege configuration register */

/* Register Addresses *******************************************************/

#define STM32H5_PWR_CR1          (STM32H5_PWR_BASE + STM32H5_PWR_CR1_OFFSET)
#define STM32H5_PWR_CR2          (STM32H5_PWR_BASE + STM32H5_PWR_CR2_OFFSET)
#define STM32H5_PWR_CR3          (STM32H5_PWR_BASE + STM32H5_PWR_CR3_OFFSET)
#define STM32H5_PWR_CR4          (STM32H5_PWR_BASE + STM32H5_PWR_CR4_OFFSET)
#define STM32H5_PWR_SR1          (STM32H5_PWR_BASE + STM32H5_PWR_SR1_OFFSET)
#define STM32H5_PWR_SR2          (STM32H5_PWR_BASE + STM32H5_PWR_SR2_OFFSET)
#define STM32H5_PWR_SCR          (STM32H5_PWR_BASE + STM32H5_PWR_SCR_OFFSET)
#define STM32H5_PWR_PUCRA        (STM32H5_PWR_BASE + STM32H5_PWR_PUCRA_OFFSET)
#define STM32H5_PWR_PDCRA        (STM32H5_PWR_BASE + STM32H5_PWR_PDCRA_OFFSET)
#define STM32H5_PWR_PUCRB        (STM32H5_PWR_BASE + STM32H5_PWR_PUCRB_OFFSET)
#define STM32H5_PWR_PDCRB        (STM32H5_PWR_BASE + STM32H5_PWR_PDCRB_OFFSET)
#define STM32H5_PWR_PUCRC        (STM32H5_PWR_BASE + STM32H5_PWR_PUCRC_OFFSET)
#define STM32H5_PWR_PDCRC        (STM32H5_PWR_BASE + STM32H5_PWR_PDCRC_OFFSET)
#define STM32H5_PWR_PUCRD        (STM32H5_PWR_BASE + STM32H5_PWR_PUCRD_OFFSET)
#define STM32H5_PWR_PDCRD        (STM32H5_PWR_BASE + STM32H5_PWR_PDCRD_OFFSET)
#define STM32H5_PWR_PUCRE        (STM32H5_PWR_BASE + STM32H5_PWR_PUCRE_OFFSET)
#define STM32H5_PWR_PDCRE        (STM32H5_PWR_BASE + STM32H5_PWR_PDCRE_OFFSET)
#define STM32H5_PWR_PUCRF        (STM32H5_PWR_BASE + STM32H5_PWR_PUCRF_OFFSET)
#define STM32H5_PWR_PDCRF        (STM32H5_PWR_BASE + STM32H5_PWR_PDCRF_OFFSET)
#define STM32H5_PWR_PUCRG        (STM32H5_PWR_BASE + STM32H5_PWR_PUCRG_OFFSET)
#define STM32H5_PWR_PDCRG        (STM32H5_PWR_BASE + STM32H5_PWR_PDCRG_OFFSET)
#define STM32H5_PWR_PUCRH        (STM32H5_PWR_BASE + STM32H5_PWR_PUCRH_OFFSET)
#define STM32H5_PWR_PDCRH        (STM32H5_PWR_BASE + STM32H5_PWR_PDCRH_OFFSET)
