/****************************************************************************
 * arch/arm/src/stm32h5/hardware/stm32h62xx_adc.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_ADC_H
#define __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_ADC_H
...
/* Register Offsets for each ADC (ADC1-2).  At offset 0x0000 for master and
 * offset 0x0100 for slave.
 */

#define STM32H5_ADC_ISR_OFFSET         0x0000  /* ADC interrupt and status register */
#define STM32H5_ADC_IER_OFFSET         0x0004  /* ADC interrupt enable register */
#define STM32H5_ADC_CR_OFFSET          0x0008  /* ADC control register */
#define STM32H5_ADC_CFGR_OFFSET        0x000c  /* ADC configuration register */
#define STM32H5_ADC_CFGR2_OFFSET       0x0010  /* ADC configuration register 2 */
#define STM32H5_ADC_SMPR1_OFFSET       0x0014  /* ADC sample time register 1 */
#define STM32H5_ADC_SMPR2_OFFSET       0x0018  /* ADC sample time register 2 */
#define STM32H5_ADC_TR1_OFFSET         0x0020  /* ADC watchdog threshold register 1 */
#define STM32H5_ADC_TR2_OFFSET         0x0024  /* ADC watchdog threshold register 2 */
#define STM32H5_ADC_TR3_OFFSET         0x0028  /* ADC watchdog threshold register 3 */
#define STM32H5_ADC_SQR1_OFFSET        0x0030  /* ADC regular sequence register 1 */
#define STM32H5_ADC_SQR2_OFFSET        0x0034  /* ADC regular sequence register 2 */
#define STM32H5_ADC_SQR3_OFFSET        0x0038  /* ADC regular sequence register 3 */
#define STM32H5_ADC_SQR4_OFFSET        0x003c  /* ADC regular sequence register 4 */
#define STM32H5_ADC_DR_OFFSET          0x0040  /* ADC regular data register */
#define STM32H5_ADC_JSQR_OFFSET        0x004c  /* ADC injected sequence register */
#define STM32H5_ADC_OFR1_OFFSET        0x0060  /* ADC offset register 1 */
#define STM32H5_ADC_OFR2_OFFSET        0x0064  /* ADC offset register 2 */
#define STM32H5_ADC_OFR3_OFFSET        0x0068  /* ADC offset register 3 */
#define STM32H5_ADC_OFR4_OFFSET        0x006c  /* ADC offset register 4 */
#define STM32H5_ADC_JDR1_OFFSET        0x0080  /* ADC injected data register 1 */
#define STM32H5_ADC_JDR2_OFFSET        0x0084  /* ADC injected data register 2 */
#define STM32H5_ADC_JDR3_OFFSET        0x0088  /* ADC injected data register 3 */
#define STM32H5_ADC_JDR4_OFFSET        0x008c  /* ADC injected data register 4 */
#define STM32H5_ADC_AWD2CR_OFFSET      0x00a0  /* ADC analog watchdog 2 configuration register */
#define STM32H5_ADC_AWD3CR_OFFSET      0x00a4  /* ADC analog watchdog 3 configuration register */
#define STM32H5_ADC_DIFSEL_OFFSET      0x00b0  /* ADC differential mode selection register 2 */
#define STM32H5_ADC_CALFACT_OFFSET     0x00b4  /* ADC calibration factors */
#define STM32H5_ADC_OR_OFFSET          0x00c8  /* ADC Option Register */

/* Master and Slave ADC Common Registers */

#define STM32H5_ADC_CSR_OFFSET         0x0000  /* Common status register */
#define STM32H5_ADC_CCR_OFFSET         0x0008  /* Common control register */
#define STM32H5_ADC_CDR_OFFSET         0x000c  /* Common Regular Data register for Dual Mode*/
#define STM32H5_ADC_HWCFGR0_OFFSET     0x00f0  /* Hardware Configuration Register */
#define STM32H5_ADC_VERR_OFFSET        0x00f4  /* Version Register */
#define STM32H5_ADC_IPDR_OFFSET        0x00f8  /* Size Identification Register */
#define STM32H5_ADC_SIDR_OFFSET        0x00fc  /* Size Identification Register */


/* Register Addresses *******************************************************/

#define STM32H5_ADC1_ISR               (STM32H5_ADC1_BASE+STM32H5_ADC_ISR_OFFSET)
#define STM32H5_ADC1_IER               (STM32H5_ADC1_BASE+STM32H5_ADC_IER_OFFSET)
#define STM32H5_ADC1_CR                (STM32H5_ADC1_BASE+STM32H5_ADC_CR_OFFSET)
#define STM32H5_ADC1_CFGR              (STM32H5_ADC1_BASE+STM32H5_ADC_CFGR_OFFSET)
#define STM32H5_ADC1_CFGR2             (STM32H5_ADC1_BASE+STM32H5_ADC_CFGR2_OFFSET)
#define STM32H5_ADC1_SMPR1             (STM32H5_ADC1_BASE+STM32H5_ADC_SMPR1_OFFSET)
#define STM32H5_ADC1_SMPR2             (STM32H5_ADC1_BASE+STM32H5_ADC_SMPR2_OFFSET)
#define STM32H5_ADC1_TR1               (STM32H5_ADC1_BASE+STM32H5_ADC_TR1_OFFSET)
#define STM32H5_ADC1_TR2               (STM32H5_ADC1_BASE+STM32H5_ADC_TR2_OFFSET)
#define STM32H5_ADC1_TR3               (STM32H5_ADC1_BASE+STM32H5_ADC_TR3_OFFSET)
#define STM32H5_ADC1_SQR1              (STM32H5_ADC1_BASE+STM32H5_ADC_SQR1_OFFSET)
#define STM32H5_ADC1_SQR2              (STM32H5_ADC1_BASE+STM32H5_ADC_SQR2_OFFSET)
#define STM32H5_ADC1_SQR3              (STM32H5_ADC1_BASE+STM32H5_ADC_SQR3_OFFSET)
#define STM32H5_ADC1_SQR4              (STM32H5_ADC1_BASE+STM32H5_ADC_SQR4_OFFSET)
#define STM32H5_ADC1_DR                (STM32H5_ADC1_BASE+STM32H5_ADC_DR_OFFSET)
#define STM32H5_ADC1_JSQR              (STM32H5_ADC1_BASE+STM32H5_ADC_JSQR_OFFSET)
#define STM32H5_ADC1_OFR1              (STM32H5_ADC1_BASE+STM32H5_ADC_OFR1_OFFSET)
#define STM32H5_ADC1_OFR2              (STM32H5_ADC1_BASE+STM32H5_ADC_OFR2_OFFSET)
#define STM32H5_ADC1_OFR3              (STM32H5_ADC1_BASE+STM32H5_ADC_OFR3_OFFSET)
#define STM32H5_ADC1_OFR4              (STM32H5_ADC1_BASE+STM32H5_ADC_OFR4_OFFSET)
#define STM32H5_ADC1_JDR1              (STM32H5_ADC1_BASE+STM32H5_ADC_JDR1_OFFSET)
#define STM32H5_ADC1_JDR2              (STM32H5_ADC1_BASE+STM32H5_ADC_JDR2_OFFSET)
#define STM32H5_ADC1_JDR3              (STM32H5_ADC1_BASE+STM32H5_ADC_JDR3_OFFSET)
#define STM32H5_ADC1_JDR4              (STM32H5_ADC1_BASE+STM32H5_ADC_JDR4_OFFSET)
#define STM32H5_ADC1_AWD2CR            (STM32H5_ADC1_BASE+STM32H5_ADC_AWD2CR_OFFSET)
#define STM32H5_ADC1_AWD3CR            (STM32H5_ADC1_BASE+STM32H5_ADC_AWD3CR_OFFSET)
#define STM32H5_ADC1_DIFSEL            (STM32H5_ADC1_BASE+STM32H5_ADC_DIFSEL_OFFSET)
#define STM32H5_ADC1_CALFACT           (STM32H5_ADC1_BASE+STM32H5_ADC_CALFACT_OFFSET)
#define STM32H5_ADC2_OR                (STM32H5_ADC1_BASE+STM32H5_ADC_OR_OFFSET)

#define STM32H5_ADC2_ISR               (STM32H5_ADC2_BASE+STM32H5_ADC_ISR_OFFSET)
#define STM32H5_ADC2_IER               (STM32H5_ADC2_BASE+STM32H5_ADC_IER_OFFSET)
#define STM32H5_ADC2_CR                (STM32H5_ADC2_BASE+STM32H5_ADC_CR_OFFSET)
#define STM32H5_ADC2_CFGR              (STM32H5_ADC2_BASE+STM32H5_ADC_CFGR_OFFSET)
#define STM32H5_ADC2_CFGR2             (STM32H5_ADC2_BASE+STM32H5_ADC_CFGR2_OFFSET)
#define STM32H5_ADC2_SMPR1             (STM32H5_ADC2_BASE+STM32H5_ADC_SMPR1_OFFSET)
#define STM32H5_ADC2_SMPR2             (STM32H5_ADC2_BASE+STM32H5_ADC_SMPR2_OFFSET)
#define STM32H5_ADC2_TR1               (STM32H5_ADC2_BASE+STM32H5_ADC_TR1_OFFSET)
#define STM32H5_ADC2_TR2               (STM32H5_ADC2_BASE+STM32H5_ADC_TR2_OFFSET)
#define STM32H5_ADC2_TR3               (STM32H5_ADC2_BASE+STM32H5_ADC_TR3_OFFSET)
#define STM32H5_ADC2_SQR1              (STM32H5_ADC2_BASE+STM32H5_ADC_SQR1_OFFSET)
#define STM32H5_ADC2_SQR2              (STM32H5_ADC2_BASE+STM32H5_ADC_SQR2_OFFSET)
#define STM32H5_ADC2_SQR3              (STM32H5_ADC2_BASE+STM32H5_ADC_SQR3_OFFSET)
#define STM32H5_ADC2_SQR4              (STM32H5_ADC2_BASE+STM32H5_ADC_SQR4_OFFSET)
#define STM32H5_ADC2_DR                (STM32H5_ADC2_BASE+STM32H5_ADC_DR_OFFSET)
#define STM32H5_ADC2_JSQR              (STM32H5_ADC2_BASE+STM32H5_ADC_JSQR_OFFSET)
#define STM32H5_ADC2_OFR1              (STM32H5_ADC2_BASE+STM32H5_ADC_OFR1_OFFSET)
#define STM32H5_ADC2_OFR2              (STM32H5_ADC2_BASE+STM32H5_ADC_OFR2_OFFSET)
#define STM32H5_ADC2_OFR3              (STM32H5_ADC2_BASE+STM32H5_ADC_OFR3_OFFSET)
#define STM32H5_ADC2_OFR4              (STM32H5_ADC2_BASE+STM32H5_ADC_OFR4_OFFSET)
#define STM32H5_ADC2_JDR1              (STM32H5_ADC2_BASE+STM32H5_ADC_JDR1_OFFSET)
#define STM32H5_ADC2_JDR2              (STM32H5_ADC2_BASE+STM32H5_ADC_JDR2_OFFSET)
#define STM32H5_ADC2_JDR3              (STM32H5_ADC2_BASE+STM32H5_ADC_JDR3_OFFSET)
#define STM32H5_ADC2_JDR4              (STM32H5_ADC2_BASE+STM32H5_ADC_JDR4_OFFSET)
#define STM32H5_ADC2_AWD2CR            (STM32H5_ADC2_BASE+STM32H5_ADC_AWD2CR_OFFSET)
#define STM32H5_ADC2_AWD3CR            (STM32H5_ADC2_BASE+STM32H5_ADC_AWD3CR_OFFSET)
#define STM32H5_ADC2_DIFSEL            (STM32H5_ADC2_BASE+STM32H5_ADC_DIFSEL_OFFSET)
#define STM32H5_ADC2_CALFACT           (STM32H5_ADC2_BASE+STM32H5_ADC_CALFACT_OFFSET)
#define STM32H5_ADC2_OR                (STM32H5_ADC2_BASE+STM32H5_ADC_OR_OFFSET)

#define STM32H5_ADC_CSR                (STM32H5_ADCCMN_BASE+STM32H5_ADC_CSR_OFFSET)
#define STM32H5_ADC_CCR                (STM32H5_ADCCMN_BASE+STM32H5_ADC_CCR_OFFSET)
#define STM32H5_ADC_CDR                (STM32H5_ADCCMN_BASE+STM32H5_ADC_CDR_OFFSET)
#define STM32H5_ADC_HWCFGR0            (STM32H5_ADCCMN_BASE+STM32H5_ADC_HWCFGR0_OFFSET)
#define STM32H5_ADC_VERR               (STM32H5_ADCCMN_BASE+STM32H5_ADC_VERR_OFFSET)
#define STM32H5_ADC_IPDR               (STM32H5_ADCCMN_BASE+STM32H5_ADC_IPDR_OFFSET)
#define STM32H5_ADC_SIDR               (STM32H5_ADCCMN_BASE+STM32H5_ADC_SIDR_OFFSET)
...
#define ADC_HWCFGR0_ADCNUM_SHIFT     (0)       /* Bits 0-3: Number of ADCs implemented */
#define ADC_HWCFGR0_ADCNUM_MASK      (0xf << ADC_HWCFGR0_ADCNUM_SHIFT) 
#define ADC_HWCFGR0_MULPIPE_SHIFT    (4)       /* Bits 0-3: Number of pipleline stages */
#define ADC_HWCFGR0_MULPIPE_MASK     (0xf << ADC_HWCFGR0_MULPIPE_SHIFT) 
#define ADC_HWCFGR0_OPBITS_SHIFT     (8)       /* Bits 0-3:  Number of option bits */
#define ADC_HWCFGR0_OPBITS_MASK      (0xf << ADC_HWCFGR0_OPBITS_SHIFT) 
#define ADC_HWCFGR0_IDLEVALUE_SHIFT  (12)       /* Bits 0-3:  Idle value for non-selected channels */
#define ADC_HWCFGR0_IDLEVALUE_MASK   (0xf << ADC_HWCFGR0_IDLEVALUE_SHIFT) 

/* ADC Version Register */
#define ADC_VERR_MINREV_SHIFT        (0)       /* ADC IP minor revision */
#define ADC_VERR_MINREV_MASK         (0xf << ADC_VERR_MINREV_SHIFT) 
#define ADC_VERR_MAJREV_SHIFT        (4)       /* ADC IP major revision */
#define ADC_VERR_MAJREV_MASK         (0xf << ADC_VERR_MAJREV_SHIFT) 

/* ADC Identification Register */
#define ADC_IPDR_ID_SHIFT            (0)       /* ADC IP minor revision */
#define ADC_IPDR_ID_MASK             (0xffffffff << ADC_IPDR_ID_SHIFT) 

/* ADC Size Identification Register */
#define ADC_SIDR_ID_SHIFT            (0)       /* ADC IP minor revision */
#define ADC_SIDR_ID_MASK             (0xffffffff << ADC_SIDR_ID_SHIFT) 

#endif /* __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_ADC_H */
