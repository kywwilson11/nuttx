...
#ifndef __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_SAI_H
#define __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_SAI_H
...
#define STM32H5_SAI_GCR_OFFSET     0x0000  /* SAI Global Configuration Register */

#define STM32H5_SAI_A_OFFSET       0x0004
#define STM32H5_SAI_B_OFFSET       0x0024

#define STM32H5_SAI_CR1_OFFSET     0x0000  /* SAI Configuration Register 1 A */
#define STM32H5_SAI_CR2_OFFSET     0x0004  /* SAI Configuration Register 2 A */
#define STM32H5_SAI_FRCR_OFFSET    0x0008  /* SAI Frame Configuration Register A */
#define STM32H5_SAI_SLOTR_OFFSET   0x000c  /* SAI Slot Register A */
#define STM32H5_SAI_IM_OFFSET      0x0010  /* SAI Interrupt Mask Register 2 A */
#define STM32H5_SAI_SR_OFFSET      0x0014  /* SAI Status Register A */
#define STM32H5_SAI_CLRFR_OFFSET   0x0018  /* SAI Clear Flag Register A */
#define STM32H5_SAI_DR_OFFSET      0x001c  /* SAI Data Register A */

/* Register Addresses *******************************************************/

#define STM32H5_SAI1_GCR           (STM32H5_SAI_GCR_OFFSET)

#define STM32H5_SAI1_A_BASE        (STM32H5_SAI1_BASE+STM32H5_SAI_A_OFFSET)
#define STM32H5_SAI1_B_BASE        (STM32H5_SAI1_BASE+STM32H5_SAI_B_OFFSET)

#define STM32H5_SAI1_ACR1          (STM32H5_SAI1_A_BASE+STM32H5_SAI_ACR1_OFFSET)
#define STM32H5_SAI1_ACR2          (STM32H5_SAI1_A_BASE+STM32H5_SAI_ACR2_OFFSET)
#define STM32H5_SAI1_AFRCR         (STM32H5_SAI1_A_BASE+STM32H5_SAI_AFRCR_OFFSET)
#define STM32H5_SAI1_ASLOTR        (STM32H5_SAI1_A_BASE+STM32H5_SAI_ASLOTR_OFFSET)
#define STM32H5_SAI1_AIM           (STM32H5_SAI1_A_BASE+STM32H5_SAI_AIM_OFFSET)
#define STM32H5_SAI1_ASR           (STM32H5_SAI1_A_BASE+STM32H5_SAI_ASR_OFFSET)
#define STM32H5_SAI1_ACLRFR        (STM32H5_SAI1_A_BASE+STM32H5_SAI_ACLRFR_OFFSET)
#define STM32H5_SAI1_ADR           (STM32H5_SAI1_A_BASE+STM32H5_SAI_ADR_OFFSET)

#define STM32H5_SAI1_BCR1          (STM32H5_SAI1_B_BASE+STM32H5_SAI_BCR1_OFFSET)
#define STM32H5_SAI1_BCR2          (STM32H5_SAI1_B_BASE+STM32H5_SAI_BCR2_OFFSET)
#define STM32H5_SAI1_BFRCR         (STM32H5_SAI1_B_BASE+STM32H5_SAI_BFRCR_OFFSET)
#define STM32H5_SAI1_BSLOTR        (STM32H5_SAI1_B_BASE+STM32H5_SAI_BSLOTR_OFFSET)
#define STM32H5_SAI1_BIM           (STM32H5_SAI1_B_BASE+STM32H5_SAI_BIM_OFFSET)
#define STM32H5_SAI1_BSR           (STM32H5_SAI1_B_BASE+STM32H5_SAI_BSR_OFFSET)
#define STM32H5_SAI1_BCLRFR        (STM32H5_SAI1_B_BASE+STM32H5_SAI_BCLRFR_OFFSET)
#define STM32H5_SAI1_BDR           (STM32H5_SAI1_B_BASE+STM32H5_SAI_BDR_OFFSET)

#define STM32H5_SAI2_GCR           (STM32H5_SAI2_BASE+STM32H5_SAI_GCR_OFFSET)

#define STM32H5_SAI2_A_BASE        (STM32H5_SAI2_BASE+STM32H5_SAI_A_OFFSET)
#define STM32H5_SAI2_B_BASE        (STM32H5_SAI2_BASE+STM32H5_SAI_B_OFFSET)

#define STM32H5_SAI2_ACR1          (STM32H5_SAI2_A_BASE+STM32H5_SAI_ACR1_OFFSET)
#define STM32H5_SAI2_ACR2          (STM32H5_SAI2_A_BASE+STM32H5_SAI_ACR2_OFFSET)
#define STM32H5_SAI2_AFRCR         (STM32H5_SAI2_A_BASE+STM32H5_SAI_AFRCR_OFFSET)
#define STM32H5_SAI2_ASLOTR        (STM32H5_SAI2_A_BASE+STM32H5_SAI_ASLOTR_OFFSET)
#define STM32H5_SAI2_AIM           (STM32H5_SAI2_A_BASE+STM32H5_SAI_AIM_OFFSET)
#define STM32H5_SAI2_ASR           (STM32H5_SAI2_A_BASE+STM32H5_SAI_ASR_OFFSET)
#define STM32H5_SAI2_ACLRFR        (STM32H5_SAI2_A_BASE+STM32H5_SAI_ACLRFR_OFFSET)
#define STM32H5_SAI2_ADR           (STM32H5_SAI2_A_BASE+STM32H5_SAI_ADR_OFFSET)

#define STM32H5_SAI2_BCR1          (STM32H5_SAI2_B_BASE+STM32H5_SAI_BCR1_OFFSET)
#define STM32H5_SAI2_BCR2          (STM32H5_SAI2_B_BASE+STM32H5_SAI_BCR2_OFFSET)
#define STM32H5_SAI2_BFRCR         (STM32H5_SAI2_B_BASE+STM32H5_SAI_BFRCR_OFFSET)
#define STM32H5_SAI2_BSLOTR        (STM32H5_SAI2_B_BASE+STM32H5_SAI_BSLOTR_OFFSET)
#define STM32H5_SAI2_BIM           (STM32H5_SAI2_B_BASE+STM32H5_SAI_BIM_OFFSET)
#define STM32H5_SAI2_BSR           (STM32H5_SAI2_B_BASE+STM32H5_SAI_BSR_OFFSET)
#define STM32H5_SAI2_BCLRFR        (STM32H5_SAI2_B_BASE+STM32H5_SAI_BCLRFR_OFFSET)
#define STM32H5_SAI2_BDR           (STM32H5_SAI2_B_BASE+STM32H5_SAI_BDR_OFFSET)
...
#endif /* __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_SAI_H */
