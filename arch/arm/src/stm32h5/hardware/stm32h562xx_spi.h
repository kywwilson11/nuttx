/****************************************************************************
 * arch/arm/src/stm32h5/hardware/stm32h5_spi.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_SPI_H
#define __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_SPI_H
...
#  define STM32H5_SPI_CLK_MAX     45000000UL
#else
...
#if STM32H5_NSPI > 0
#  define STM32H5_SPI1_CR1          (STM32H5_SPI1_BASE + STM32H5_SPI_CR1_OFFSET)
#  define STM32H5_SPI1_CR2          (STM32H5_SPI1_BASE + STM32H5_SPI_CR2_OFFSET)
#  define STM32H5_SPI1_SR           (STM32H5_SPI1_BASE + STM32H5_SPI_SR_OFFSET)
#  define STM32H5_SPI1_DR           (STM32H5_SPI1_BASE + STM32H5_SPI_DR_OFFSET)
#  define STM32H5_SPI1_CRCPR        (STM32H5_SPI1_BASE + STM32H5_SPI_CRCPR_OFFSET)
#  define STM32H5_SPI1_RXCRCR       (STM32H5_SPI1_BASE + STM32H5_SPI_RXCRCR_OFFSET)
#  define STM32H5_SPI1_TXCRCR       (STM32H5_SPI1_BASE + STM32H5_SPI_TXCRCR_OFFSET)
#endif

#if STM32H5_NSPI > 1
#  define STM32H5_SPI2_CR1          (STM32H5_SPI2_BASE + STM32H5_SPI_CR1_OFFSET)
#  define STM32H5_SPI2_CR2          (STM32H5_SPI2_BASE + STM32H5_SPI_CR2_OFFSET)
#  define STM32H5_SPI2_SR           (STM32H5_SPI2_BASE + STM32H5_SPI_SR_OFFSET)
#  define STM32H5_SPI2_DR           (STM32H5_SPI2_BASE + STM32H5_SPI_DR_OFFSET)
#  define STM32H5_SPI2_CRCPR        (STM32H5_SPI2_BASE + STM32H5_SPI_CRCPR_OFFSET)
#  define STM32H5_SPI2_RXCRCR       (STM32H5_SPI2_BASE + STM32H5_SPI_RXCRCR_OFFSET)
#  define STM32H5_SPI2_TXCRCR       (STM32H5_SPI2_BASE + STM32H5_SPI_TXCRCR_OFFSET)
#endif

#if STM32H5_NSPI > 2
#  define STM32H5_SPI3_CR1          (STM32H5_SPI3_BASE + STM32H5_SPI_CR1_OFFSET)
#  define STM32H5_SPI3_CR2          (STM32H5_SPI3_BASE + STM32H5_SPI_CR2_OFFSET)
#  define STM32H5_SPI3_SR           (STM32H5_SPI3_BASE + STM32H5_SPI_SR_OFFSET)
#  define STM32H5_SPI3_DR           (STM32H5_SPI3_BASE + STM32H5_SPI_DR_OFFSET)
#  define STM32H5_SPI3_CRCPR        (STM32H5_SPI3_BASE + STM32H5_SPI_CRCPR_OFFSET)
#  define STM32H5_SPI3_RXCRCR       (STM32H5_SPI3_BASE + STM32H5_SPI_RXCRCR_OFFSET)
#  define STM32H5_SPI3_TXCRCR       (STM32H5_SPI3_BASE + STM32H5_SPI_TXCRCR_OFFSET)
#endif
...
#endif /* __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_SPI_H */
