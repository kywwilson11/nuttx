/****************************************************************************
 * arch/arm/src/stm32h5/hardware/stm32h562xx_syscfg.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H562XX_SYSCFG_H
#define __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H562XX_SYSCFG_H
...
#define STM32H5_SYSCFG_SECCFGR_OFFSET   0x0000 /* SYSCFG secure configuration register */
#define STM32H5_SYSCFG_CFGR1_OFFSET     0x0004 /* SYSCFG configuration register 1 */
#define STM32H5_SYSCFG_FPUIMR_OFFSET    0x0008 /* SYSCFG FPU interrupt mask register */
#define STM32H5_SYSCFG_CNSLCKR_OFFSET   0x000c /* SYSCFG CPU non-secure lock register */
#define STM32H5_SYSCFG_CSLCKR_OFFSET    0x0010 /* SYSCFG CPU secure lock register */
#define STM32H5_SYSCFG_CFGR2_OFFSET     0x0014 /* SYSCFG configuration register 2 */
#define STM32H5_SYSCFG_SCSR_OFFSET      0x0018 /* SYSCFG SRAM2 control and status register */
#define STM32H5_SYSCFG_SKR_OFFSET       0x001c /* SYSCFG SRAM2 key register */
#define STM32H5_SYSCFG_SWPR_OFFSET      0x0020 /* SYSCFG SRAM2 write protection register */
#define STM32H5_SYSCFG_SWPR2_OFFSET     0x0024 /* SYSCFG SRAM2 write protection register 2 */
#define STM32H5_SYSCFG_RSSCMDR_OFFSET   0x002c /* SYSCFG RSS command register */

/* Register Addresses *******************************************************/

#define STM32H5_SYSCFG_SECCFGR          (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_SECCFGR_OFFSET)
#define STM32H5_SYSCFG_CFGR1            (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_CFGR1_OFFSET)
#define STM32H5_SYSCFG_FPUIMR           (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_FPUIMR_OFFSET)
#define STM32H5_SYSCFG_CNSLCKR          (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_CNSLCKR_OFFSET)
#define STM32H5_SYSCFG_CSLCKR           (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_CSLCKR_OFFSET)
#define STM32H5_SYSCFG_CFGR2            (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_CFGR2_OFFSET)
#define STM32H5_SYSCFG_SCSR             (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_SCSR_OFFSET)
#define STM32H5_SYSCFG_SKR              (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_SKR_OFFSET)
#define STM32H5_SYSCFG_SWPR             (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_SWPR_OFFSET)
#define STM32H5_SYSCFG_SWPR2            (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_SWPR2_OFFSET)
#define STM32H5_SYSCFG_RSSCMDR          (STM32H5_SYSCFG_BASE + STM32H5_SYSCFG_RSSCMDR_OFFSET)
...
#endif /* __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H562XX_SYSCFG_H */
