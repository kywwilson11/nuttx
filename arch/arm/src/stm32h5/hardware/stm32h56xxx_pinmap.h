...
#define GPIO_TIM1_ETR_1            (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN7)       /* PE7: TIM1_ETR */

#define GPIO_TIM1_BKIN_1           (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN6)       /* PA6: TIM1_BKIN */
#define GPIO_TIM1_BKIN_2           (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN15)      /* PE15: TIM1_BKIN */
#define GPIO_TIM1_BKIN_3           (GPIO_ALT|GPIO_AF1|GPIO_PORTH|GPIO_PIN12)      /* PH12: TIM1_BKIN */

#define GPIO_TIM1_BKIN2_1          (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN6)       /* PE6: TIM1_BKIN2 */

/* --- TIM1: CH1..CH4 (OUT) and CH1N..CH4N (compl.) ---------------------- */

#define GPIO_TIM1_CH1OUT_1         (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN8)       /* PA8:  TIM1_CH1 */
#define GPIO_TIM1_CH1OUT_2         (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN9)       /* PE9:  TIM1_CH1 */
#define GPIO_TIM1_CH1NOUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN7)       /* PA7:  TIM1_CH1N */
#define GPIO_TIM1_CH1NOUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PORTH|GPIO_PIN10)      /* PH10: TIM1_CH1N */

#define GPIO_TIM1_CH2OUT_1         (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN9)       /* PA9:  TIM1_CH2 */
#define GPIO_TIM1_CH2OUT_2         (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN11)      /* PE11: TIM1_CH2 */
#define GPIO_TIM1_CH2NOUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN10)      /* PE10: TIM1_CH2N */
#define GPIO_TIM1_CH2NOUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PORTH|GPIO_PIN8)       /* PH8:  TIM1_CH2N */

#define GPIO_TIM1_CH3OUT_1         (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN10)      /* PA10: TIM1_CH3 */
#define GPIO_TIM1_CH3OUT_2         (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN13)      /* PE13: TIM1_CH3 */
#define GPIO_TIM1_CH3NOUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN12)      /* PE12: TIM1_CH3N */
#define GPIO_TIM1_CH3NOUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PORTH|GPIO_PIN6)       /* PH6:  TIM1_CH3N */

#define GPIO_TIM1_CH4OUT_1         (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN14)      /* PE14: TIM1_CH4 */
#define GPIO_TIM1_CH4NOUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN15)      /* PE15: TIM1_CH4N */

/* --- TIM2: pins -------------------------------------------------- */

#define GPIO_TIM2_ETR_1           (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN0)   /* PA0:  TIM2_ETR */
#define GPIO_TIM2_ETR_2           (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN15)  /* PA15: TIM2_ETR */
#define GPIO_TIM2_ETR_3           (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN5)   /* PA5:  TIM2_ETR */

#define GPIO_TIM2_CH1OUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN0)   /* PA0:  TIM2_CH1 */
#define GPIO_TIM2_CH1OUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN15)  /* PA15: TIM2_CH1 */
#define GPIO_TIM2_CH1OUT_3        (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN5)   /* PA5:  TIM2_CH1 */

#define GPIO_TIM2_CH2OUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN1)   /* PA1:  TIM2_CH2 */
#define GPIO_TIM2_CH2OUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN3)   /* PB3:  TIM2_CH2 */

#define GPIO_TIM2_CH3OUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN2)   /* PA2:  TIM2_CH3 */
#define GPIO_TIM2_CH3OUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN10)  /* PB10: TIM2_CH3 */

#define GPIO_TIM2_CH4OUT_1        (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN3)   /* PA3:  TIM2_CH4 */
#define GPIO_TIM2_CH4OUT_2        (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN11)  /* PB11: TIM2_CH4 */
#define GPIO_TIM2_CH4OUT_3        (GPIO_ALT|GPIO_AF1|GPIO_PORTC|GPIO_PIN4)   /* PC4:  TIM2_CH4 */

/* --- TIM3: pins -------------------------------------------------- */

#define GPIO_TIM3_ETR_1           (GPIO_ALT|GPIO_AF2|GPIO_PORTD|GPIO_PIN2)   /* PD2:  TIM3_ETR */

#define GPIO_TIM3_CH1OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTA|GPIO_PIN6)   /* PA6:  TIM3_CH1 */
#define GPIO_TIM3_CH1OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTB|GPIO_PIN4)   /* PB4:  TIM3_CH1 */
#define GPIO_TIM3_CH1OUT_3        (GPIO_ALT|GPIO_AF2|GPIO_PORTC|GPIO_PIN6)   /* PC6:  TIM3_CH1 */

#define GPIO_TIM3_CH2OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTA|GPIO_PIN7)   /* PA7:  TIM3_CH2 */
#define GPIO_TIM3_CH2OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTB|GPIO_PIN5)   /* PB5:  TIM3_CH2 */
#define GPIO_TIM3_CH2OUT_3        (GPIO_ALT|GPIO_AF2|GPIO_PORTC|GPIO_PIN7)   /* PC7:  TIM3_CH2 */

#define GPIO_TIM3_CH3OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTB|GPIO_PIN0)   /* PB0:  TIM3_CH3 */
#define GPIO_TIM3_CH3OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTC|GPIO_PIN8)   /* PC8:  TIM3_CH3 */

#define GPIO_TIM3_CH4OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTB|GPIO_PIN1)   /* PB1:  TIM3_CH4 */
#define GPIO_TIM3_CH4OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTC|GPIO_PIN9)   /* PC9:  TIM3_CH4 */

/* --- TIM4: pins -------------------------------------------------- */

#define GPIO_TIM4_ETR_1           (GPIO_ALT|GPIO_AF2|GPIO_PORTE|GPIO_PIN0)   /* PE0:  TIM4_ETR */

#define GPIO_TIM4_CH1OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTB|GPIO_PIN6)   /* PB6:  TIM4_CH1 */
#define GPIO_TIM4_CH1OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTD|GPIO_PIN12)  /* PD12: TIM4_CH1 */

#define GPIO_TIM4_CH2OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTB|GPIO_PIN7)   /* PB7:  TIM4_CH2 */
#define GPIO_TIM4_CH2OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTD|GPIO_PIN13)  /* PD13: TIM4_CH2 */

#define GPIO_TIM4_CH3OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTB|GPIO_PIN8)   /* PB8:  TIM4_CH3 */
#define GPIO_TIM4_CH3OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTD|GPIO_PIN14)  /* PD14: TIM4_CH3 */

#define GPIO_TIM4_CH4OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTB|GPIO_PIN9)   /* PB9:  TIM4_CH4 */
#define GPIO_TIM4_CH4OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTC|GPIO_PIN2)   /* PC2:  TIM4_CH4 */
#define GPIO_TIM4_CH4OUT_3        (GPIO_ALT|GPIO_AF2|GPIO_PORTD|GPIO_PIN15)  /* PD15: TIM4_CH4 */

/* --- TIM5: pins -------------------------------------------------- */

#define GPIO_TIM5_ETR_1           (GPIO_ALT|GPIO_AF2|GPIO_PORTA|GPIO_PIN4)   /* PA4:  TIM5_ETR */
#define GPIO_TIM5_ETR_2           (GPIO_ALT|GPIO_AF2|GPIO_PORTH|GPIO_PIN8)   /* PH8:  TIM5_ETR */

#define GPIO_TIM5_CH1OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTA|GPIO_PIN0)   /* PA0:  TIM5_CH1 */
#define GPIO_TIM5_CH1OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTH|GPIO_PIN10)  /* PH10: TIM5_CH1 */

#define GPIO_TIM5_CH2OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTA|GPIO_PIN1)   /* PA1:  TIM5_CH2 */
#define GPIO_TIM5_CH2OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTH|GPIO_PIN11)  /* PH11: TIM5_CH2 */

#define GPIO_TIM5_CH3OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTA|GPIO_PIN2)   /* PA2:  TIM5_CH3 */
#define GPIO_TIM5_CH3OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTH|GPIO_PIN12)  /* PH12: TIM5_CH3 */

#define GPIO_TIM5_CH4OUT_1        (GPIO_ALT|GPIO_AF2|GPIO_PORTA|GPIO_PIN3)   /* PA3:  TIM5_CH4 */
#define GPIO_TIM5_CH4OUT_2        (GPIO_ALT|GPIO_AF2|GPIO_PORTI|GPIO_PIN0)   /* PI0:  TIM5_CH4 */

/* --- TIM8: ETR / BKIN / BKIN2 ------------------------------------------ */

#define GPIO_TIM8_ETR_1            (GPIO_ALT|GPIO_AF3|GPIO_PORTA|GPIO_PIN0)       /* PA0:  TIM8_ETR */
#define GPIO_TIM8_ETR_2            (GPIO_ALT|GPIO_AF3|GPIO_PORTI|GPIO_PIN3)       /* PI3:  TIM8_ETR */

#define GPIO_TIM8_BKIN_1           (GPIO_ALT|GPIO_AF3|GPIO_PORTH|GPIO_PIN12)      /* PH12: TIM8_BKIN */
#define GPIO_TIM8_BKIN_2           (GPIO_ALT|GPIO_AF3|GPIO_PORTI|GPIO_PIN4)       /* PI4:  TIM8_BKIN */

#define GPIO_TIM8_BKIN2_1          (GPIO_ALT|GPIO_AF3|GPIO_PORTA|GPIO_PIN8)       /* PA8:  TIM8_BKIN2 */
#define GPIO_TIM8_BKIN2_2          (GPIO_ALT|GPIO_AF3|GPIO_PORTI|GPIO_PIN1)       /* PI1:  TIM8_BKIN2 */

/* --- TIM8: CH1..CH4 (OUT) and CH1N..CH3N (compl.) ---------------------- */

#define GPIO_TIM8_CH1OUT_1         (GPIO_ALT|GPIO_AF3|GPIO_PORTH|GPIO_PIN6)       /* PH6:  TIM8_CH1 */
#define GPIO_TIM8_CH1OUT_2         (GPIO_ALT|GPIO_AF3|GPIO_PORTI|GPIO_PIN5)       /* PI5:  TIM8_CH1 */
#define GPIO_TIM8_CH1NOUT_1        (GPIO_ALT|GPIO_AF3|GPIO_PORTA|GPIO_PIN5)       /* PA5:  TIM8_CH1N */
#define GPIO_TIM8_CH1NOUT_2        (GPIO_ALT|GPIO_AF3|GPIO_PORTA|GPIO_PIN7)       /* PA7:  TIM8_CH1N */
#define GPIO_TIM8_CH1NOUT_3        (GPIO_ALT|GPIO_AF3|GPIO_PORTH|GPIO_PIN7)       /* PH7:  TIM8_CH1N */
#define GPIO_TIM8_CH1NOUT_4        (GPIO_ALT|GPIO_AF3|GPIO_PORTH|GPIO_PIN13)      /* PH13: TIM8_CH1N */

#define GPIO_TIM8_CH2OUT_1         (GPIO_ALT|GPIO_AF3|GPIO_PORTH|GPIO_PIN8)       /* PH8:  TIM8_CH2 */
#define GPIO_TIM8_CH2NOUT_1        (GPIO_ALT|GPIO_AF3|GPIO_PORTH|GPIO_PIN9)       /* PH9:  TIM8_CH2N */
#define GPIO_TIM8_CH2NOUT_2        (GPIO_ALT|GPIO_AF3|GPIO_PORTH|GPIO_PIN14)      /* PH14: TIM8_CH2N */

#define GPIO_TIM8_CH3OUT_1         (GPIO_ALT|GPIO_AF3|GPIO_PORTH|GPIO_PIN10)      /* PH10: TIM8_CH3 */
#define GPIO_TIM8_CH3NOUT_1        (GPIO_ALT|GPIO_AF3|GPIO_PORTH|GPIO_PIN11)      /* PH11: TIM8_CH3N */
#define GPIO_TIM8_CH3NOUT_2        (GPIO_ALT|GPIO_AF3|GPIO_PORTH|GPIO_PIN15)      /* PH15: TIM8_CH3N */

#define GPIO_TIM8_CH4OUT_1         (GPIO_ALT|GPIO_AF3|GPIO_PORTI|GPIO_PIN2)       /* PI2:  TIM8_CH4 */

/* --- TIM15: pins ------------------------------------------------- */

#define GPIO_TIM15_BKIN_1         (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN0)   /* PA0:  TIM15_BKIN */
#define GPIO_TIM15_BKIN_2         (GPIO_ALT|GPIO_AF1|GPIO_PORTD|GPIO_PIN2)   /* PD2:  TIM15_BKIN */
#define GPIO_TIM15_BKIN_3         (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN3)   /* PE3:  TIM15_BKIN */

#define GPIO_TIM15_CH1OUT_1       (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN2)   /* PA2:  TIM15_CH1 */
#define GPIO_TIM15_CH1OUT_2       (GPIO_ALT|GPIO_AF1|GPIO_PORTC|GPIO_PIN12)  /* PC12: TIM15_CH1 */
#define GPIO_TIM15_CH1OUT_3       (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN5)   /* PE5:  TIM15_CH1 */

#define GPIO_TIM15_CH1NOUT_1      (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN1)   /* PA1:  TIM15_CH1N */
#define GPIO_TIM15_CH1NOUT_2      (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN4)   /* PE4:  TIM15_CH1N */

#define GPIO_TIM15_CH2OUT_1       (GPIO_ALT|GPIO_AF1|GPIO_PORTA|GPIO_PIN3)   /* PA3:  TIM15_CH2 */
#define GPIO_TIM15_CH2OUT_2       (GPIO_ALT|GPIO_AF1|GPIO_PORTE|GPIO_PIN6)   /* PE6:  TIM15_CH2 */

/* --- TIM16: pins ------------------------------------------------- */

#define GPIO_TIM16_BKIN_1         (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN4)   /* PB4:  TIM16_BKIN */
#define GPIO_TIM16_BKIN_2         (GPIO_ALT|GPIO_AF1|GPIO_PORTC|GPIO_PIN0)   /* PC0:  TIM16_BKIN */
#define GPIO_TIM16_BKIN_3         (GPIO_ALT|GPIO_AF1|GPIO_PORTF|GPIO_PIN10)  /* PF10: TIM16_BKIN */

#define GPIO_TIM16_CH1OUT_1       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN8)   /* PB8:  TIM16_CH1 */
#define GPIO_TIM16_CH1OUT_2       (GPIO_ALT|GPIO_AF1|GPIO_PORTF|GPIO_PIN6)   /* PF6:  TIM16_CH1 */

#define GPIO_TIM16_CH1NOUT_1      (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN6)   /* PB6:  TIM16_CH1N */
#define GPIO_TIM16_CH1NOUT_2      (GPIO_ALT|GPIO_AF1|GPIO_PORTF|GPIO_PIN8)   /* PF8:  TIM16_CH1N */

/* --- TIM17: pins ------------------------------------------------- */

#define GPIO_TIM17_BKIN_1         (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN5)   /* PB5:  TIM17_BKIN */
#define GPIO_TIM17_BKIN_2         (GPIO_ALT|GPIO_AF1|GPIO_PORTG|GPIO_PIN6)   /* PG6:  TIM17_BKIN */

#define GPIO_TIM17_CH1OUT_1       (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN9)   /* PB9:  TIM17_CH1 */
#define GPIO_TIM17_CH1OUT_2       (GPIO_ALT|GPIO_AF1|GPIO_PORTC|GPIO_PIN2)   /* PC2:  TIM17_CH1 */
#define GPIO_TIM17_CH1OUT_3       (GPIO_ALT|GPIO_AF1|GPIO_PORTF|GPIO_PIN7)   /* PF7:  TIM17_CH1 */

#define GPIO_TIM17_CH1NOUT_1      (GPIO_ALT|GPIO_AF1|GPIO_PORTB|GPIO_PIN7)   /* PB7:  TIM17_CH1N */
#define GPIO_TIM17_CH1NOUT_2      (GPIO_ALT|GPIO_AF1|GPIO_PORTF|GPIO_PIN9)   /* PF9:  TIM17_CH1N */
