...
#ifndef __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_WDG_H
#define __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_WDG_H
...
#define STM32H5_IWDG_KR_OFFSET     0x0000  /* Key register (32-bit) */
#define STM32H5_IWDG_PR_OFFSET     0x0004  /* Prescaler register (32-bit) */
#define STM32H5_IWDG_RLR_OFFSET    0x0008  /* Reload register (32-bit) */
#define STM32H5_IWDG_SR_OFFSET     0x000c  /* Status register (32-bit) */
#define STM32H5_IWDG_WINR_OFFSET   0x0010  /* Window register (32-bit) */

#define STM32H5_WWDG_CR_OFFSET     0x0000  /* Control Register (32-bit) */
#define STM32H5_WWDG_CFR_OFFSET    0x0004  /* Configuration register (32-bit) */
#define STM32H5_WWDG_SR_OFFSET     0x0008  /* Status register (32-bit) */

/* Register Addresses *******************************************************/

#define STM32H5_IWDG_KR            (STM32H5_IWDG_BASE+STM32H5_IWDG_KR_OFFSET)
#define STM32H5_IWDG_PR            (STM32H5_IWDG_BASE+STM32H5_IWDG_PR_OFFSET)
#define STM32H5_IWDG_RLR           (STM32H5_IWDG_BASE+STM32H5_IWDG_RLR_OFFSET)
#define STM32H5_IWDG_SR            (STM32H5_IWDG_BASE+STM32H5_IWDG_SR_OFFSET)
#define STM32H5_IWDG_WINR          (STM32H5_IWDG_BASE+STM32H5_IWDG_WINR_OFFSET)

#define STM32H5_WWDG_CR            (STM32H5_WWDG_BASE+STM32H5_WWDG_CR_OFFSET)
#define STM32H5_WWDG_CFR           (STM32H5_WWDG_BASE+STM32H5_WWDG_CFR_OFFSET)
#define STM32H5_WWDG_SR            (STM32H5_WWDG_BASE+STM32H5_WWDG_SR_OFFSET)
...
#endif /* __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_WDG_H */
