...
#define RCC_APB1LRSTR_CRSRST             (1 << 28) /* Bit 28: CEC reset */
...
#define RCC_AHB1ENR_FLITFEN              (1 << 8)  /* Bit 8:  Flash Interace clock enable */
...
#define RCC_APB1LLPENR_CRSLPEN             (1 << 28) /* Bit 28: CEC clock enable during sleep mode */
