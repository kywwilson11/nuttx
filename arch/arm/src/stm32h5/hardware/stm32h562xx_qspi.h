...
#ifndef __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_QSPI_H
#define __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_QSPI_H
...
#define STM32H5_QUADSPI_CR_OFFSET       0x0000    /* Control Register */
#define STM32H5_QUADSPI_DCR_OFFSET      0x0004    /* Device Configuration Register */
#define STM32H5_QUADSPI_SR_OFFSET       0x0008    /* Status Register */
#define STM32H5_QUADSPI_FCR_OFFSET      0x000c    /* Flag Clear Register */
#define STM32H5_QUADSPI_DLR_OFFSET      0x0010    /* Data Length Register */
#define STM32H5_QUADSPI_CCR_OFFSET      0x0014    /* Communication Configuration Register */
#define STM32H5_QUADSPI_AR_OFFSET       0x0018    /* Address Register */
#define STM32H5_QUADSPI_ABR_OFFSET      0x001c    /* Alternate Bytes Register */
#define STM32H5_QUADSPI_DR_OFFSET       0x0020    /* Data Register */
#define STM32H5_QUADSPI_PSMKR_OFFSET    0x0024    /* Polling Status mask Register */
#define STM32H5_QUADSPI_PSMAR_OFFSET    0x0028    /* Polling Status match Register */
#define STM32H5_QUADSPI_PIR_OFFSET      0x002c    /* Polling Interval Register */
#define STM32H5_QUADSPI_LPTR_OFFSET     0x0030    /* Low-Power Timeout Register */

/* QSPI register addresses **************************************************/

#define STM32H5_QUADSPI_CR       (STM32H5_QSPI_BASE+STM32H5_QUADSPI_CR_OFFSET)    /* Control Register */
#define STM32H5_QUADSPI_DCR      (STM32H5_QSPI_BASE+STM32H5_QUADSPI_DCR_OFFSET)   /* Device Configuration Register */
#define STM32H5_QUADSPI_SR       (STM32H5_QSPI_BASE+STM32H5_QUADSPI_SR_OFFSET)    /* Status Register */
#define STM32H5_QUADSPI_FCR      (STM32H5_QSPI_BASE+STM32H5_QUADSPI_FCR_OFFSET)   /* Flag Clear Register */
#define STM32H5_QUADSPI_DLR      (STM32H5_QSPI_BASE+STM32H5_QUADSPI_DLR_OFFSET)   /* Data Length Register */
#define STM32H5_QUADSPI_CCR      (STM32H5_QSPI_BASE+STM32H5_QUADSPI_CCR_OFFSET)   /* Communication Configuration Register */
#define STM32H5_QUADSPI_AR       (STM32H5_QSPI_BASE+STM32H5_QUADSPI_AR_OFFSET)    /* Address Register */
#define STM32H5_QUADSPI_ABR      (STM32H5_QSPI_BASE+STM32H5_QUADSPI_ABR_OFFSET)   /* Alternate Bytes Register */
#define STM32H5_QUADSPI_DR       (STM32H5_QSPI_BASE+STM32H5_QUADSPI_DR_OFFSET)    /* Data Register */
#define STM32H5_QUADSPI_PSMKR    (STM32H5_QSPI_BASE+STM32H5_QUADSPI_PSMKR_OFFSET) /* Polling Status mask Register */
#define STM32H5_QUADSPI_PSMAR    (STM32H5_QSPI_BASE+STM32H5_QUADSPI_PSMAR_OFFSET) /* Polling Status match Register */
#define STM32H5_QUADSPI_PIR      (STM32H5_QSPI_BASE+STM32H5_QUADSPI_PIR_OFFSET)   /* Polling Interval Register */
#define STM32H5_QUADSPI_LPTR     (STM32H5_QSPI_BASE+STM32H5_QUADSPI_LPTR_OFFSET)  /* Low-Power Timeout Register */
...
#endif /* __ARCH_ARM_SRC_STM32H5_HARDWARE_STM32H5_QSPI_H */
