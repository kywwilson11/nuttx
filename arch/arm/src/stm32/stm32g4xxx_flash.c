...
/* TODO - Change this properly for STM32G4
#if !(defined(CONFIG_STM32_STM32X3) || defined(CONFIG_STM32_STM32X5) || \
      defined(CONFIG_STM32_STM32X6) || defined(CONFIG_STM32_STM32XR))
